...
digital data need to be developed. One of the possible new data sources is earth observation data.
...
In a first step the project will focus on the further development and integration into a working routine at Destatis of an already existing indicator, provided by the European Space Agency. This indicator, which follows the occupation of outdoor parking lots at car production facilities is developed as a proxy for car production levels. To further improve early economy estimation another indicator based on the knowledge and resources built up during adapting the first indicator, a second indicator shall be developed in a second step during the project.
